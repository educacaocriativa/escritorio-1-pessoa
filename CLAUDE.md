...
- **Dívida:** `"no banco"` tem sentidos **opostos** em duas telas — na Projeção é o saldo que o e1p calculou; na Conferência é o que o banco atestou. São as duas pontas exatas da comparação, com a mesma palavra. Decisão da @architect (UX-001).
